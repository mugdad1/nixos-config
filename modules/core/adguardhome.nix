{pkgs, ...}: {
  # AdGuard Home runs a local 127.0.0.1:53 resolver (see networking.nix: when
  # this is enabled, systemd-resolved is disabled and the system is pointed at
  # AdGuard for DNS).
  services.adguardhome = {
    enable = true;
    host = "127.0.0.1";
    port = 3000;
    openFirewall = false; # web UI on loopback only
